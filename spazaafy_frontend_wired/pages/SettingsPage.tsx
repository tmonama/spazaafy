...
// Remove Header imports from here
...
const SettingsPage: React.FC = () => {
    ...
    // ✅ REMOVED: The check for isInternal and the Header rendering. 
    // The Layout (App.tsx) will now handle the header.

    return (
        <div className="min-h-screen bg-gray-100 dark:bg-dark-bg p-4 sm:px-6 lg:px-8 py-8">
