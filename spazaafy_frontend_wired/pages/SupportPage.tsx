                            ...
                            <form onSubmit={handleSubmit} className="space-y-4">
                                ...
                                <div>
                                    ...
                                    <textarea
                                        ...
                                        className="mt-1 block w-full px-3 py-2 border border-gray-300 dark:border-dark-surface rounded-md shadow-sm focus:outline-none focus:ring-dark-border focus:border-dark-border sm:text-sm bg-white dark:bg-dark-input text-gray-900 dark:text-gray-100"
                                    ></textarea>
                                </div>
