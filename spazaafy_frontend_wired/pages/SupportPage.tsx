...
import { AlertsProvider } from '../components/AlertsContext'; // Import the provider

// ✅ 1. Create a new component for the actual page content.
// This component will be a child of AlertsProvider and can access its context.
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            await mockApi.tickets.create({
                ...
                subject: newTicket.title, // Assuming subject is same as title for simplicity
            });
...
// ✅ 2. The main component is now a lightweight wrapper.
// It sets up the Provider, and then renders the Header and Content as children.
