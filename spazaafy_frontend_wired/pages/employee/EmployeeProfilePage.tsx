...
const EmployeeProfilePage: React.FC = () => {
  ...
  return (
    <div className="p-6 max-w-4xl mx-auto">
      {/* Main Profile Header */}
      <Card className="p-8 mb-6 relative border-t-4 border-purple-500">
        {/* ✅ Force centering regardless of Card internals */}
        <div className="w-full flex flex-col items-center text-center">
          {/* ✅ Avatar perfectly centered */}
          <div className="w-32 h-32 rounded-full bg-gray-200 mb-4 overflow-hidden border-4 border-white shadow-lg relative group mx-auto">
            {emp.photo_url ? (
          ...
          {/* ✅ Badge centered + tight width */}
          <span className="mt-2 inline-flex justify-center bg-blue-100 text-blue-800 px-3 py-1 rounded-full text-xs font-bold">
            {String(emp.status || '').replaceAll('_', ' ')}
          </span>
        </div>
      </Card>
