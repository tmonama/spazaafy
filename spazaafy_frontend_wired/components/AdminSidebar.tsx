...
import { useAlerts } from '../components/AlertsContext'; // ✅ 1. Import the alerts hook
import NotificationDot from './NotificationDot'; // ✅ 2. Import the dot component

const AdminSidebar: React.FC = () => {
    const { isSidebarOpen, setIsSidebarOpen } = useSidebar();
    const { alerts } = useAlerts(); // ✅ 3. Get the alert counts
        ...
        >
            <div className="p-4 pt-20 lg:pt-4">
                ...
                <nav className="mt-6 space-y-2">
                    {/* ✅ 4. Wrap links in a relative div and add NotificationDot */}
