...
import {UserCircle, Settings, LifeBuoy} from 'lucide-react'
            ...
            {/* Bottom Section: Support & Settings */}
                <div className="pt-4 border-t border-gray-200 dark:border-gray-700 space-y-2">
                    ...
                    <NavLink 
                        ...
                        className="flex items-center px-4 py-2 text-sm font-medium text-blue-600 bg-blue-50 rounded-lg hover:bg-blue-100 dark:bg-blue-900/20 dark:text-blue-300 dark:hover:bg-blue-900/40 mt-2"
                    >
